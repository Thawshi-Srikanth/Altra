...
export const productCategoryData = [
  { id: 1, img1: microscope, img2: micros, alt: "brand01",title:"Equipment" },
  { id: 2, img1: filterpapers, img2: filter, alt: "brand01",title:"Filter Paper / Consumables" },
  { id: 3, img1: labfurniture, img2: labfur, alt: "brand01",title:"Lab Furniture" },
  { id: 4, img1: chemicals, img2: chemi, alt: "brand01",title:"Chemical & Reagents" },
];
