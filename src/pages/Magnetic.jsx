...
function Magnetic() {
  return (
    <div className=" w-full pr-[10px] md:pr-6 flex xl:mt-[160px] lg:mt-[100px] md:mt-[90px] lg:pb-6 mt-[50px] relative md:right-[10px] lg:right-0  md:scale-100 right-[4px] 2xl:top-[80px]  xl:top-[50px] lg:left-[-23px] xl:left-[-5px]">
