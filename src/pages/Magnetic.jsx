...
function Magnetic() {
  return (
    <div className="flex xl:mt-[160px] lg:mt-[100px] md:mt-[130px] lg:pb-6 mt-[50px]">
      <div className="md:pt-[10px] pt-[10px] rounded-[12px] lg:pt-0 md:left-[50px] md:w-[740px] md:h-[140px] md:rounded-[15px] lg:left-0 lg:mt-[18px] lg:px-[20px] xl:ml-[90px] 2xl:ml-[180px]  lg:ml-[60px] relative lg:rounded-[45px] bg-white bg-opacity-80 lg:h-[200px] xl:h-[250px] xl:w-[1255px] 2xl:w-[1250px]  lg:w-[900px] w-[385px] h-[87px] left-[20px] ">
        <div>
          {" "}
        ...
        <div className="">
          {" "}
          <p className="text-[10px] font-rosario md:text-[19px] md:mt-[-10px] md:pt-[10px] lg:pt-0 lg:text-[22px] xl:text-[33px] lg:mt-[10px] lg:px-[10px]  lg:ml-[20px] md:ml-[30px] ml-[20px] xl:mt-[0px]">
