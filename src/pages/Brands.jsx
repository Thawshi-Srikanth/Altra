...
const MemoRizedBrands = memo(function Brands() {
  return (
    <div className=" w-full overscroll-x-auto xl:mt-[230px]">
      ...
      <div className="xl:scale-110 bg-[#FFFFFF] sm:block hidden lg:h-[155px] md:h-[130px] sm:h-[110px] sm:mt-[30px] md:mt-[30px] mt-[20px] h-[60px] opacity-80">
        <div className="xl:scale-125 lg:mt-[30px] flex lg:gap-[50px] gap-[20px] md:gap-[50px] xl:gap-[90px] sm:gap-[80px] md:top-[10px] top-[5px] justify-start [&_li]:mx-8 [&_img]:max-w-96 animate-infinite-scroll">
          {brands.map((brand) => (
            <div
              key={brand.id}
      ...
      <div className="bg-[#FFFFFF] opacity-80">
        {" "}
        <div className="mx-auto flex  items-center gap-[24px]  sm:hidden   relative   top-[4px]    [&_img]:max-w-sm  animate-infinite-scroll ">
          {brands.map((brand) => (
