...
const MemoRizedBrands = memo(function Brands() {
  ...
  return (
    <div className=" w-full overscroll-x-auto xl:mt-[-30px] xl:scale-90">
      <h1 className="md:text-[35px] text-[25px] xl:text-[69px] lg:text-[50px] sm:text-[30px] font-rosario text-white  text-center lg:mt-[60px] md:mt-[30px] mt-[20px]  font-bold xl:mt-[190px]">
        Our trusted brands
      </h1>
