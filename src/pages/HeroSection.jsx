...
function HeroSection() {
  return (
    <div className=" relative pb-[15px]  lg:pb-0   [background:linear-gradient(180deg,_#fff_70%,_rgba(2,_2,_1,_0))]  lg:h-[500px] grid grid-cols-3 lg:px-[90px]  bg-white w-full xl:mt-[-40px] top-[0px] ">
      <div className="col-span-2 lg:mt-[60px] mt-[0px] md:mt-[60px] relative xl:left-[35px] left-[30px] ">
        ...
        <div className="md:text-[30px] sm:text-[28px] md:mt-[-12px]   2xl:text-[69px] xl:text-[61px] lg:text-[40px] font-rosario lg:gap-[20px] xl:gap-[20px] lg:flex xl:mt-[-37px] lg:mt-[-20px]">
          ...
          <span className="text-[#DC7C42] font-bold lg:ml-[10px] relative left-[8px] lg:left-0 text-nowrap">
