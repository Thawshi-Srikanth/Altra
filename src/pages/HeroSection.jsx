...
function HeroSection() {
  return (
    <div className=" relative pb-[15px]  lg:pb-0  [background:linear-gradient(180deg,_#fff_70.9%,_rgba(2,_2,_1,_0))]  lg:h-[500px] grid grid-cols-3 lg:px-[90px]  bg-white w-full xl:mt-[-40px] top-[-0px] ">
      <div className="col-span-2 lg:mt-[60px] mt-[20px] md:mt-[60px] relative xl:left-[35px] left-[30px] ">
        ...
        <div className="lg:mt-[px] lg:ml-[-35px] xl:ml-0 mt-[2px] md:mt-0 ">
          ...
          <p className="pb-[20px]  sm:pb-0 lg:ml-[86px] text-[9px] md:text-[12px] sm:text-[9px] font-rosario lg:text-[20px]  text-[#e18655] lg:mt-[20px] md:mt-[10px] mt-[5px] relative left-[12px] sm:ml-[-5px] md:left-5 lg:left-0">
