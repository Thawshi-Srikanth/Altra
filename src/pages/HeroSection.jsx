  ...
  return (
    <div className="relative pb-[15px]  lg:pb-0  [background:linear-gradient(180deg,_#fff_70.9%,_rgba(2,_2,_1,_0))]  lg:h-[500px] grid grid-cols-3 lg:px-[90px]  bg-white ">
      <div className="col-span-2 lg:mt-[60px] mt-[20px] md:mt-[60px] relative xl:left-[35px] left-[30px]">
        <div className="lg:flex lg:flex-row 2xl:text-[69px] xl:text-[60px] lg:text-[40px] text-[20px] md:text-[40px] font-rosario  lg:gap-[20px]">
        ...
        <div className="md:text-[30px] md:mt-[-12px]   2xl:text-[69px] xl:text-[61px] lg:text-[40px] font-rosario lg:gap-[20px] xl:gap-[20px] lg:flex xl:mt-[-37px] lg:mt-[-20px]">
