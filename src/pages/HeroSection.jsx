...
function HeroSection() {
  return (
    <div className="relative   [background:linear-gradient(180deg,_#fff_57.9%,_rgba(2,_2,_1,_0))]  lg:h-[500px] lg:grid lg:grid-cols-3 lg:px-[90px]   ">
      <div className="lg:col-span-2 lg:mt-[60px] ">
        ...
        <div className="lg:mt-[px]">
          {" "}
          <button className="lg:bg-[#ff8a3a] lg:h-[80px] lg:w-[280px] lg:text-30px lg:rounded-[20px] lg:mt-[30px] lg:text-[30px] text-white font-rosario shadow-[15px_15px_30px_rgba(0,_0,_0,_0.25)]">
            Inquire Now
          </button>
