...
function Clientele() {
  return (
    <div className="overflow-x-hidden lg:pb-[80px] md:pb-[60px]  relative bottom-[130px] md:bottom-0  sm:bottom-[30px]">
      ...
      <div className="bg-white opacity-80 lg:h-[152px] xl:h-[200px] md:h-[80px] sm:h-[80px] h-[58px] relative mt-[30px] md:mt-0">
        {" "}
        <div className="xl:gap-[120px] lg:gap-[100px]  gap-[40px] md:gap-[90px]  sm:gap-[90px] lg:mt-[30px] md:mt-[20px] sm:mt-[20px] flex  md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll ">
          {clients.map((brand) => (
            <div
              key={brand.id}
      ...
      <div className="bg-white opacity-80 lg:h-[152px] xl:h-[200px] sm:h-[80px] md:h-[80px] h-[58px] relative mt-[21px] md:mt-0">
      <div className="xl:gap-[120px] lg:gap-[100px] md:gap-[90px]  sm:gap-[90px] gap-[40px] lg:mt-[30px] md:mt-[20px]    flex  md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll-reverse ">
