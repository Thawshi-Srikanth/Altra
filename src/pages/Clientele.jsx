...
const MemoRizedClientele=memo(function Clientele() {
  return (
    <div
      className={`  sm:mt-[30px]  w-full overscroll-x-auto xl:pb-[120px] lg:pb-[150px] md:pb-[60px]  relative bottom-[130px] md:bottom-0  sm:bottom-[330px]  xl:mt-[120px]    md:mt-[100px]`}
    >
      <h1 className="xl:scale-90 md:mt-[50px] sm:text-[30px]  md:text-[35px] text-[25px]  lg:pt-[40px] lg:text-[40px] 2xl:text-[69px] xl:text-[60px] font-rosario text-white  text-center xl:mt-[60px] font-bold">
        Clientele
      </h1>
      <div className="  bg-[#FFFFFF] opacity-80 lg:h-[190px] xl:h-[170px] md:h-[100px] sm:h-[80px] h-[50px] relative mt-[30px] md:mt-0">
        {" "}
        <div className="xl:scale-90 flex-row flex-nowrap xl:gap-[60px] lg:gap-[100px]  gap-[10px] md:gap-[60px]  sm:gap-[50px] lg:mt-[30px] md:mt-[20px] sm:mt-[20px] flex md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scrollClientle scroll-smooth">
          {clients.map((brand) => (
            <div
              key={brand.id}
            ...
            >
              <img
                src={brand.img}
                alt={brand.alt}
                className="sm:block hidden object-contain"
              />
