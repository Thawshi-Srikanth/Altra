  ...
  return (
    <div className="xl:mb-[-80px] lg:mb-[-70px] md:mb-[-70px] ">
      <div>
        <video
          src={researchVideo}
          className=" object-cover w-full 2xl:h-[700px] lg:h-[600px] md:h-[400px] sm:h-[300px] h-[209px] relative top-8 sm:top-0 "
          alt="research"
          playsInline
        ...
        <div className="sm:block hidden xl:bottom-60 lg:bottom-60 mdBottom   2xl:left-[770px]  xl:left-[630px] lg:left-[500px]   left-4 mx-auto justify-center  absolute ">
          <img
            src={research}
            className="sm:justify-end   object-cover 2xl:w-[689px] xl:w-[589px] xl:h-[190px] lg:w-[500px]  lg:h-[150px] md:w-[390px] sm:w-[300px] sm:h-[100px] w-[325px] h-[60px] mx-auto justify-center rounded-md"
            alt="research"
          />
        </div>
        <div className="sm:hidden mobBottom   mx-auto justify-center  absolute flex">
          <img
            src={researchMob}
            className="sm:justify-end   object-cover 2xl:w-[689px] xl:w-[589px] xl:h-[190px] lg:w-[500px]  lg:h-[150px] md:w-[400px] sm:w-[300px] sm:h-[100px] w-[300px] h-[60px] mx-auto justify-center rounded-md"
            alt="research"
          />
        </div>
      </div>
