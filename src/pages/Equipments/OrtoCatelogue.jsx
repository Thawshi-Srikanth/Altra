...
function OrtoCatelogue({ catelogue }) {
  ...
  return (
    <div className="  relative xl:top-[30px] lg:top-[30px] sm:top-[20px] sm:mb-[200px] md:mb-[0px] lg:mb-[0px] xl:mb-[0px] xl:space-y-10 sm:space-y-7 md:space-y-0 space-y-5 mb-10">
      ...
      <div className=" grid grid-cols-3 xl:gap-x-[0px] lg:gap-x-[10px] sm:gap-x-[30px] md:gap-x-[20px]  gap-x-[10px] justify-center  xl:mx-[200px] md:mx-[100px]  sm:mx-[90px]  mx-[15px] lg:mx-[90px]  xl:space-y-[60px] lg:space-y-10 space-y-5  sm:space-y-8  md:space-y-12 items-baseline">
        {firstRow.map((image) => (
          <div
      ...
      <div className=" flex xl:gap-x-[20px] lg:gap-x-[10px] sm:gap-x-[30px] md:gap-x-[20px]  gap-x-[10px] justify-center  xl:mx-[130px] md:mx-[30px]  sm:mx-[20px]  mx-[15px] lg:mx-[0px]  xl:space-y-0 lg:space-y-10 space-y-0  sm:space-y-8  md:space-y-12 items-baseline">
        {finalRow.map((image) => (
          <div
            className="cursor-pointer justify-center mx-auto "
            key={image.id}
