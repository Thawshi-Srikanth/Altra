...
function PhScale() {
  return (
    <div className="flex xl:mt-[210px] lg:mt-[120px] lg:pb-6 ">
      <div className="  lg:mt-[18px] lg:px-[20px] xl:ml-[90px] 2xl:ml-[180px]  lg:ml-[60px] relative lg:rounded-[45px] bg-white bg-opacity-90 lg:h-[200px] xl:h-[250px] xl:w-[1255px] 2xl:w-[1250px]  lg:w-[1050px]">
        ...
        <div className="lg:top-[10px] relative">
          {" "}
          <p className="font-rosario lg:text-[27px] xl:text-[33px] lg:mt-[10px] lg:px-[10px]  lg:ml-[20px] xl:mt-[0px]  lg:leading-[120%]">
