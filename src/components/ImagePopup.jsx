...
function ImagePopup({ imageId, catelogue, catelogueHorizontal, onClose }) {
  ...
  return (
    ...
    >
      <div
        className="  h-9 overflow-y-hidden absolute md:bottom-[390px] sm:bottom-[340px] sm:left-[70px] md:left-[200px] lg:left-[320px] 2xl:left-0 lg:top-9 lg:bottom-[620px] xl:bottom-0 sm:ml-[350px] hover:scale-125 ml-[200px] top-[170px] sm:top-0  xl:ml-[490px] 2xl:ml-[940px] xl:top-[120px] cursor-pointer "
        onClick={onClose}
      >
        <X size={30} className="overflow-y-hidden relative top-3 xlhide" />
      </div>
      {popUpImageGlassWare.map((image) => (
        ...
        >
          <img
            ...
            className="select-none justify-center mx-auto lg:w-[350px] lg:h-[300px] w-[220px] h-[200px] overflow-hidden "
          />
        </div>
      ))}
    </div>
