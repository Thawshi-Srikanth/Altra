...
function ImagePopup({
  ...
  return (
    ...
    >
      <div
        className="absolute md:bottom-[390px] sm:bottom-[340px] sm:left-[70px] md:left-[200px] lg:left-[320px] 2xl:left-0 lg:top-9 lg:bottom-[620px] sm:ml-[350px] hover:scale-125 ml-[200px] top-[230px] sm:top-0 xl:ml-[800px] 2xl:ml-[960px] xl:top-[60px] cursor-pointer "
        onClick={onClose}
      >
        <X size={30} />
      </div>
