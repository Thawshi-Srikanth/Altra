      ...
      <div className="bg-[#2D2D2D] lg:grid lg:grid-cols-3 grid sm:grid-cols-3 lg:h-[400px] md:h-[250px] sm:h-[210px] h-[600px] relative">
        ...
        <div className="left-[40px]  mx-auto  sm:mx-0 sm:scale-75 md:scale-100 lg:top-[50px]  relative lg:right-[30px] md:left-[90px]  sm:left-[20px] lg:left-0  xl:right-0 xl:scale-90 md:mt-[45px] lg:mt-0 sm:mt-[27px] mt-[75px] px-2 sm:px-0">
          <div className="lg:left-[130px] xl:left-[190px] relative grid grid-cols-2 sm:grid-cols-1 gap-[90px] sm:gap-0 text-nowrap">
            <p className="text-white font-rosario xl:text-[23px] sm:text-[15px] lg:text-[20px] md:text-[15px] text-[15px] lg:my-[17px] relative right-[15px] sm:right-0">
            ...
            />
            <p className="text-white font-rosario xl:text-[23px] lg:text-[20px] md:text-[15px] text-[15px] lg:my-[17px] lg:pl-[60px] relative bottom-[10px] sm:pt-[18px] md:pt-[10px] lg:pt-0">
