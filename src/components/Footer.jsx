  ...
  return (
    <div className=" ">
      <div className="bg-[#2D2D2D] lg:grid lg:grid-cols-3 lg:h-[400px] ">
        <div className="flex flex-col justify-center xl:ml-[80px] lg:ml-[30px] relative ">
          <div className="">
        ...
        <div className="lg:top-[50px]  relative lg:right-[30px]  xl:right-0">
      ...
      <div className="bg-[#666666] lg:h-[55px]   ">
        <div className="flex justify-between font-rosario  lg:text-[17px] lg:top-[15px] relative">
          ...
          <p className="relative right-[60px]">
            | Crafted by <span className="hover:text-[#FF8A3A] ml-[5px]">Arrow Reach Digital</span>
          </p>
        </div>
      </div>
    </div>
