    ...
    <div>
      ...
      <div className="bg-[#FF8A3A]  md:mb-[-80px] mb-[0px]">
        ...
        <Link to={`/productCatelgoue/${nextpath}`} className="">
          ...
          <img
            src={imgThree}
            className="transition duration-500 hover:scale-125  mx-auto justify-center items-center relative lg:top-20 sm:top-[50px] top-[60px] lg:w-[650px] lg:h-[188px] md:w-[600px] md:h-[148px] sm:w-[400px] sm:h-[100px] w-[190px] h-[55px]"
          />
        </Link>
